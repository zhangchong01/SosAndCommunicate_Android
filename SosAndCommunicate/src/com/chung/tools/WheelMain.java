...
//		int textSize = (screenheight / 100) * 2;
		wv_day.TEXT_SIZE = 23;//textSize;
		wv_month.TEXT_SIZE =23; //textSize;
		wv_year.TEXT_SIZE = 23; //textSize;
		wv_hours.TEXT_SIZE = 23;//textSize;
		wv_mins.TEXT_SIZE = 23;//textSize;
